...
namespace Tests
{
    ...
    public class RunExeCommandTests
    {
        ...
        [Test]
        [CustomAutoData]
        public async Task Bucket_option_is_correctly_parsed(RunExeCommand sut, CommandHandlerSpy commandHandler, string program, string bucket, string filePrefix)
        {
            sut.Handler = commandHandler;

            await sut.InvokeAsync($"exe {program} --bucket {bucket} --prefix {filePrefix}");
        ...
        [Test]
        [CustomAutoData]
        public async Task FilePrefix_option_is_correctly_parsed(RunExeCommand sut, CommandHandlerSpy commandHandler, string program, string bucket, string filePrefix)
        {
            sut.Handler = commandHandler;
        ...
        [Test]
        [CustomAutoData]
        public async Task Token_option_is_correctly_parsed_when_added(RunExeCommand sut, CommandHandlerSpy commandHandler, string program, string bucket, string filePrefix, string token)
        {
            sut.Handler = commandHandler;

            await sut.InvokeAsync($"exe {program} --bucket {bucket} --prefix {filePrefix} --token {token}");
        ...
        [Test]
        [CustomAutoData]
        public async Task Token_option_is_null_when_not_added(RunExeCommand sut, CommandHandlerSpy commandHandler, string program, string bucket, string filePrefix)
        {
            sut.Handler = commandHandler;
        ...
        [Test]
        [CustomAutoData]
        public async Task PathToProgram_is_correctly_parsed(RunExeCommand sut, CommandHandlerSpy commandHandler, string program, string bucket, string filePrefix)
        {
            sut.Handler = commandHandler;
